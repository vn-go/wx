...
*/
func (ctx *HttpContext[TIdentifier]) StreamingFile(fileName string) error {
...
*/
func (ctx *HttpContext[TIdentifier]) DownloadFile(fileName string) error {
...
func (h *HttpContext[TIdentifier]) GetAbsRootUri() string {
	if h.rootAbsUrl != "" {
		return h.rootAbsUrl
	}
	scheme := h.GetScheme()
...
func (h *HttpContext[TIdentifier]) GetScheme() string {
	if h.schema != "" {
		return h.schema
	}
	h.schema = "http"
